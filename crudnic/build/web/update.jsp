...
//        con = DriverManager.getConnection("jdbc:mysql://localhost/user","root","");
    ...
    Connection con = new Jdbc().getConnection();
       ...
       PreparedStatement pst = con.prepareStatement("update records set fname =?, nic=?, mobile=? where id=?"); 
...
//                            con = DriverManager.getConnection("jdbc:mysql://localhost/user","root","");
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="index.jsp" class="btn btn-success float-right"> Back To Main Page</a>
                </div>
            </div>
        </div>
